...
- O framework de *queues / worker management* adotado foi o `pg-boss`.
...
- **NUNCA** construa processos HTTP neste módulo de runtime (Para isso, use a API `apps/api` via *Fastify*).
