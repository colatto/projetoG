...
- testes: inclui `audit.routes.test.ts` (PRD-09 leitura), `dashboard.routes.test.ts` (RBAC e filtros PRD-08), `notification.routes.test.ts` (PRD-03 §7.5), `followup.routes.test.ts`, `damages.routes.test.ts` (PRD-06), `webhooks.test.ts` (ACK-only), `integration.test.ts` (filtros + aliases PRD-09)
- build: passa
- lint: passa
