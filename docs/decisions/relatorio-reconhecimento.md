...
| 8   | **Dashboard e Indicadores**                 | §13        | 🟡 Parcial | Snapshots diários (`dashboard_*`), job `dashboard:consolidation`, API `/api/dashboard/*`, telas `/admin/dashboard/*` (PRD-08); evoluções documentadas em `docs/prd/prd-08-dashboard-e-indicadores.md`. |
...
- Banco PostgreSQL 17 disponível, com a modelagem inicial e migrações já processadas.
